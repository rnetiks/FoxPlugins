...
namespace Autumn.Animation
{
    ...
    /// </summary>
    public class CornerAnimation : GUIAnimation
    {
        ...
        public CornerAnimation(GUIBase @base, StartPoint startPoint, Rect finishRect) : this(@base, StartPointToRect(startPoint), finishRect)
        {
        }

        private CornerAnimation(GUIBase @base, Rect startRect, Rect finishRect) : base(@base)
        {
        ...
        {
            nextFramesCount = Mathf.CeilToInt(1f / Time.deltaTime);
