...
{
    public class SetAlphaNode : BaseCompositorNode
    {
        public override string Title { get; } = "Set Alpha";
        public static string Group => "Color";
        protected override void InitializePorts()
        {
            _inputs.Add(new NodeInput("Image", SocketType.RGBA, new Vector2(0, Size.y * 0.6f)));
            _inputs.Add(new NodeInput("Alpha", SocketType.Alpha, new Vector2(0, Size.y * 0.7f)));
