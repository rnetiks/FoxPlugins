...
namespace Compositor.KK.Utilities
{
    public class MathNode : BaseCompositorNode
    {
        ...
        {
            _inputs.Add(new NodeInput("In", SocketType.Alpha, new Vector2(0, Size.y * 0.5f)));
            _inputs.Add(new NodeInput("In", SocketType.Alpha, new Vector2(0, Size.y * 0.6f)));
            _outputs.Add(new NodeOutput("Out", SocketType.Alpha, new Vector2(Size.x, Size.y * 0.5f)));
        }
