...
namespace Crystalize.UIElements
{
    ...
    public class Gradient : IDisposable
    {
        ...
        private ColorPicker _colorSelector;
        ...
        public Gradient()
        {
            ...
            _colorSelector = new ColorPicker();
        ...
        public void Draw(Rect rect)
        {
            ...
            {
                Rect colorRect = new Rect(rect.x, rect.y + barHeight + stopHeight + 5, rect.width, rect.width);
        ...
        public UnityEngine.Gradient ToUnityGradient()
        {
