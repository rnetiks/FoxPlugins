...
namespace Crystalize
{
    public class Texture
    {
        ...
        /// <summary>
        /// Retrieves a cached texture associated with the specified key. If no such texture is cached,
        /// creates a new texture using the provided creator function and caches it.
        /// </summary>
        /// <param name="key">The key associated with the texture.</param>
        /// <param name="creator">A function that creates the texture if it does not already exist in the cache.</param>
        /// <returns>The texture associated with the specified key.</returns>
