...
namespace Crystalize
{
	public class Curve
	{
		...
		public static Vector3[] ResamplePoly(Vector3[] points, int count, bool smooth = true)
		{
			...
			RuntimeILReferenceBag.FastDelegateInvokers.Func<Vector3, Vector3, Vector3, Vector3, float, Vector3> solver = CatmullRom;
