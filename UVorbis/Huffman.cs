...
namespace NVorbis
{
    class Huffman : IHuffman, IComparer<HuffmanListNode>
    {
        ...
        public void GenerateTable(IReadOnlyList<int> values, int[] lengthList, int[] codeList)
        {
            ...
            TableBits = tableBits;
            PrefixTree = new ReadOnlyListWrapper<HuffmanListNode>(prefixList);
            OverflowList = overflowList != null ? (IReadOnlyList<HuffmanListNode>)new ReadOnlyListWrapper<HuffmanListNode>(overflowList) : null;
        }
