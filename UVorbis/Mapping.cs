    ...
    class Mapping : IMapping
    {
        ...
        public void Init(IPacket packet, int channels, IFloor[] floors, IResidue[] residues, IMdct mdct)
        {
            ...
            for (var j = 0; j < couplingSteps; j++)
            {
                ...
                {
                    throw new Exception("Invalid magnitude or angle in mapping header!");
                }
            ...
            {
                throw new Exception("Reserved bits not 0 in mapping header.");
            }
            ...
            if (submapCount > 1)
            {
                for (var c = 0; c < channels; c++)
                {
                    ...
                    {
                        throw new Exception("Invalid channel mux submap index in mapping header!");
                    }
                }
            }
            ...
            for (var j = 0; j < submapCount; j++)
            {
                ...
                {
                    throw new Exception("Invalid floor number in mapping header!");
                }
                var residueNum = (int)packet.ReadBits(8);
                if (residueNum >= residues.Length)
                {
                    throw new Exception("Invalid residue number in mapping header!");
                }
