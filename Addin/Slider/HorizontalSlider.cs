...
namespace Addin
{
    ...
    public class HorizontalSlider
    {
        ...
        public HorizontalSlider(float value, float minValue, float maxValue, string label = "", string format = "F2")
        {
            _value = value;
            _minValue = minValue;
            _maxValue = maxValue;
        ...
        public HorizontalSlider(float value, float minValue, float maxValue, float defaultValue, string label = "", string format = "F2")
        {
            _value = value;
            _minValue = minValue;
            _maxValue = maxValue;
