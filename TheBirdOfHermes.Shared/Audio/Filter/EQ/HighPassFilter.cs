...
namespace TheBirdOfHermes.Audio.Filter
{
    ...
    /// </summary>
    public class HighPassFilter : AudioFilterBase
    {
        public override string Name { get; set; } = "High Pass";
        public override string Group { get; set; } = "EQ";

        private string _cutoffInput = "200";
        ...
        public override void Process(AudioData data)
        {
            ...
            for (int ch = 0; ch < channels; ch++)
            {
                ...
                {
                    var f = new Biquad();
                    f.Configure(Biquad.Type.HighPass, data.SampleRate, cutoff, 0.707f);
