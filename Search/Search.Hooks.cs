...
namespace Search
{
    ...
    {
		/// <summary>
		///     This class handles Bepinex/Config detection of <see cref="BepInEx.Configuration.KeyboardShortcut" />> and simulates
		///     fake presses.
		/// </summary>
		private static class Hooks
        {
			/// <summary>
			///     We assume that every time the keyboard shortcut is being polled, that it's being watched, and we record the time
			///     since the last get. This is useful to see if a shortcut is currently viable as many times shortcuts can be
			///     contextual.
			/// </summary>
			[HarmonyPostfix]
